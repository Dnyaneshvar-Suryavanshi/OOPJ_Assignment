public class Library {
    ...
    Library(String title, String author, boolean issued) {
        this.title = title;
        this.author = author;
        this.issued = issued;
    ...
    public static void main(String[] args) {
        Library b1 = new Library("Harry Potter", "J.K. Rowling", true);
        Library b2 = new Library("Five Point Someone", "Chetan Bhagat", false);
        Library b3 = new Library("Rich Dad Poor Dad", "Robert Kiyosaki", true);
